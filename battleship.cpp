...
int main()
{
	...
	while (player_ship != NULL && ai_ship != NULL)
	{
	...
	if (player_ship == NULL)
	{
		std::cout << "The enemy has destroyed all of your ships. The AI has won the game!" << std::endl;
	}
	else if (ai_ship == NULL)
	{
		std::cout << "You have destroyed all of the enemy's ships. You have won the game!" << std::endl;
	}
